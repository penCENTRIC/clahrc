...
module TextHelper
  ...
  def self.truncate_at_space(text, max_length, ellipsis = '&hellip;')
    ellipsis_doc = Hpricot(ellipsis.to_s)
    l = [max_length - ellipsis_doc.inner_text.mb_chars.length, 0].max
